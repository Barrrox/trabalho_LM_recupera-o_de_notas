...
teste_6:
    ...
    debug_print_anomalias:
    
    ; Imprime cabeçalho de debug
    mov rdi, formato_debug_header
    xor rax, rax
    call printf
    
    ; Configura para percorrer o buffer
...
debug_loop:
    ...
    ; Imprime cada valor do buffer
    mov rax, 1
    mov rdi, formato_debug_item
    movss xmm0, [anomalias_buffer + rbx*4]
    cvtss2sd xmm0, xmm0
    call printf
